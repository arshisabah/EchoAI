...
const MeetingRoom = ({ userInfo }) => {
  ...
  useEffect(() => {
    ...
    // ✅ Only connect if password is not required OR password is provided
    if (active && (!roomInfo?.password || password)) {
      ...
      <div className="meeting-content">
        ...
        <div className="meeting-video-section">
          <VideoGrid
            ...
            participants={participants}  // ✅ Pass participants as-is, VideoGrid will handle deduplication
